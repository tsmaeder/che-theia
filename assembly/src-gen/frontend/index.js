...
module.exports = Promise.resolve()
    ...
    .then(function () { return Promise.resolve(require('@eclipse-che/theia-remote-api/lib/browser/che-remote-api-frontend-module')).then(load) })
    .then(function () { return Promise.resolve(require('@eclipse-che/theia-plugin-ext/lib/browser/che-frontend-module')).then(load) })
    .then(function () { return Promise.resolve(require('@eclipse-che/theia-remote/lib/browser/plugin-remote-frontend-module')).then(load) })
    .then(function () { return Promise.resolve(require('@eclipse-che/theia-terminal/lib/browser/terminal-frontend-module')).then(load) })
    .then(function () { return Promise.resolve(require('@eclipse-che/theia-user-preferences-synchronizer/lib/browser/che-theia-user-preferences-frontend-module')).then(load) })
    ...
    .then(function () { return Promise.resolve(require('@eclipse-che/theia-about/lib/browser/about-frontend-module')).then(load) })
    .then(function () { return Promise.resolve(require('@eclipse-che/theia-preferences-provider-extension/lib/browser/prefs-provider-extension-frontend-module')).then(load) })
    .then(function () { return Promise.resolve(require('@eclipse-che/theia-git-provisioner/lib/browser/git-frontend-module')).then(load) })
    .then(function () { return Promise.resolve(require('@eclipse-che/theia-mini-browser/lib/browser/che-mini-browser-frontend-module')).then(load) })
    .then(function () { return Promise.resolve(require('@eclipse-che/theia-file-sync-tracker/lib/browser/che-theia-file-sync-frontend-module')).then(load) })
    .then(function () { return Promise.resolve(require('@eclipse-che/theia-cli-endpoint/lib/browser/cli-frontend-module')).then(load) })
    .then(function () { return Promise.resolve(require('@eclipse-che/theia-workspace-extension/lib/browser/che-workspace-module')).then(load) })
